...
| `tunnel.config.externalDNS.server`       | If configured, the Tunnel API will pull this server to fecth domains which will be added to the `/etc/hosts` of the connected clients                                                                                                                                        | `""`    |
